...
const NewsSection = () => {
  return (
    <div className="h-full">
      ...
      <div className=" bg-blend-multiply bg-[var(--color-yellow)]/50 bg-[image:var(--news-bg)] bg-center bg-cover text-center text-white py-10">
        <div className="max-w-[var(--main-w-container)] p-4 mx-auto">
          ...
          <p className="py-5 text-pretty text-shadow-md">
            Your contribution will help cover providing disaster relief packs
            ($15 per pack) and shelter repairs ($595 per home).
          </p>
